    ...
    >
      ...
      >
        ...
        <div className="absolute inset-3 flex flex-col">
          ...
          {/* Content area preview — reflects layout variant */}
          {template.style.layoutVariant === 'A' && (
            <div className="flex-1 bg-white/90 rounded-sm p-2 flex gap-1">
              <div className="flex-1 flex flex-col gap-1">
                <div className="h-1.5 w-3/4 rounded-sm" style={{ backgroundColor: template.colors.headingColor }} />
                <div className="h-1 w-1/2 rounded-sm bg-gray-300" />
                <div className="flex-1 rounded-sm bg-gray-100 mt-1" />
              </div>
              <div className="w-2/5 rounded-sm bg-gray-200" />
            </div>
          )}
          {template.style.layoutVariant === 'B' && (
            <div className="flex-1 bg-white/90 rounded-sm p-2 flex flex-col gap-1">
              <div className="h-2/5 rounded-sm bg-gray-200" />
              <div className="h-1.5 w-3/4 rounded-sm" style={{ backgroundColor: template.colors.headingColor }} />
          ...
          {template.style.layoutVariant === 'C' && (
            <div className="flex-1 bg-white/90 rounded-sm p-2 flex gap-1">
              <div className="w-2/5 rounded-sm flex flex-col gap-1" style={{ backgroundColor: `${template.colors.primary}15` }}>
                <div className="h-1.5 w-3/4 rounded-sm mx-1 mt-1" style={{ backgroundColor: template.colors.headingColor }} />
                <div className="flex-1 rounded-sm bg-gray-100 mx-1 mb-1" />
              </div>
      ...
      <div className="p-2 bg-white">
        ...
        <div className="flex items-center gap-1.5 mt-1">
          ...
          <span className="text-[9px] text-gray-400 ml-auto">
            {template.style.layoutVariant === 'A' ? 'Classic' : template.style.layoutVariant === 'B' ? 'Editorial' : 'Modern'}
          </span>
        </div>
      </div>
    </button>
